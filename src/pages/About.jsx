      ...
      <section className="about-hero">
        <div className="container about-hero__inner">
          ...
          <p className="about-hero__subtitle">
            We connect trading companies with the industrial equipment and supplies they need to
            operate at peak efficiency — reliably, seamlessly, and at scale.
          </p>
          ...
          <div className="about-mv__grid">
            <div className="about-mv__card about-mv__card--mission">
              ...
              <p className="about-mv__card-desc">
                ...
                leaders — expanding our global reach and creating sustainable growth for both our people and the organization.
              </p>
      ...
      <section className="about-trusted">
        <div className="container about-trusted__inner">
          ...
          <p className="about-trusted__desc">
            From small businesses to established companies, we empower organizations of all sizes with office
            supplies, pantry and janitorial essentials, and health and wellness products — delivered with quality
            at the best price.
          </p>
        </div>
      </section>
          ...
          <div className="about-enterprise__inner">
            ...
            <div className="about-enterprise__imgs">
              {ENTERPRISE_IMGS.map((im, i) => (
                <Link to="/products" key={i} className="about-enterprise__img-wrap" style={{ textDecoration: "none" }}>
